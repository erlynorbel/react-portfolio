...
const Footer = () => (
  <footer className="footer border-top py-3">
    <div className="container text-center">
      <p className = 'FooterText'>&copy; 2025 Lebron Paulmark D. Dimayacyac. All rights reserved.</p>
      <div className="social-links">
        <a href="https://www.linkedin.com/in/lebron-dimayacyac-286ba62a1/" target="_blank" rel="noopener noreferrer" title="LinkedIn">
          <i className="bi bi-linkedin" style={{ color: '#000' }}></i>
        </a>
